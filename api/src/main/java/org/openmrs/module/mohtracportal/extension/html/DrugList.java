 ...
 */
public class DrugList extends AdministrationSectionExt {
	...
	public String getTitle() {
		return "mohtracportal.drug.manage.list";
	}
	...
	public Map<String, String> getLinks() {
		...
		map.put("module/mohtracportal/drug.list", "mohtracportal.drug.manage.list");
